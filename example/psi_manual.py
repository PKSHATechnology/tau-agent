...
def main():
    config: AgentConfig = AgentConfig(
        model="gpt-4o",
        prompt="あなたは PSI というプロダクトのサポートエージェントです。問い合わせに対して、マニュアルを参照しながら適切な情報を提供してください。最後に、文章を可愛くしてください。",
        tools=[
            AgentToolConfig(
                tool="http_get_json",
                args={
            ...
            AgentToolConfig(
                ...
                args={
                    ...
                    "agent": {
                        "model": "gpt-4o",
                        "prompt": "文章が与えられたら、語尾に「チャビ」を付けて可愛くしてください。可愛くした後のテキストだけを出力してください。",
                        "tools": [],
                    },
                },
            ),
